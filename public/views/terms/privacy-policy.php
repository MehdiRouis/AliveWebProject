<main class="container-fluid">
    <div class="card">
        <div class="card-content justify-align dividmb">
            ...
            <p class="card-title">1. Introduction</p>
            <div class="divider"></div>
            ...
            <p class="card-title">2. Collecte des renseignements personnels</p>
            <div class="divider"></div>
            ...
            <p class="card-title">3. Formulaires  et interactivité:</p>
            <div class="divider"></div>
            ...
            <p class="card-title">4. Fichiers journaux et témoins</p>
            <div class="divider"></div>
            ...
            <p class="card-title">5. Droit d'opposition et de retrait</p>
            <div class="divider"></div>
            ...
            <ol>
                <li>Adresse : 31 rue Ferdinand Cartier, Résidence des jardins de l'abbaye, Notre-Dame-De-Bondeville 76960</li>
                <li>Courriel : mehdi.rouis.1@laposte.net</li>
                <li>Téléphone : 06 52 63 22 12</li>
                <li>Section du site web : <a href="lienprofile">awp.fr/lienpasserprivé</a></li>
            </ol>
            <p class="card-title">Droit d'accès</p>
            <div class="divider"></div>
            ...
            <ol>
                ...
                <li>Courriel : mehdi.rouis.1@laposte.net</li>
                <li>Téléphone : 06 52 63 22 12</li>
                <li>Section du site web : <a href="lienprofile">awp.fr/lienmodifInfos</a></li>
            </ol>
